...
export function buildSystemPrompt() {
  return [
    ...
    '- Respond with a concise JSON analysis of what you see so the user can remix it.',
    ...
    '- Keep tone factual and avoid embellishing beyond what is visible. If a field is unknown, set it to an empty string.',
    '',
